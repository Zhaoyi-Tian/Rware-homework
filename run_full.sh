...
echo "=== Phase 1: tiny-2ag 80M — 5 进程并行 ==="
...
PID4=$!
caffeinate python main.py --algorithm seac_cc     --env rware-tiny-2ag-v2 --total-steps 80000000 --seed 42 &
PID5=$!
wait $PID1 $PID2 $PID3 $PID4 $PID5
echo "=== tiny-2ag done ==="

echo "=== Phase 2: small-4ag 150M — 5 进程并行 ==="
...
caffeinate python main.py --algorithm seac_cc     --env rware-small-4ag-v2 --total-steps 150000000 --seed 42 &
wait
echo "=== All done ==="
